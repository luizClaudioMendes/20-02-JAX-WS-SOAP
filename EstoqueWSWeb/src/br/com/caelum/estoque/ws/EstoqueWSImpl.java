...
@WebService(endpointInterface="br.com.caelum.estoque.ws.EstoqueWS", serviceName="EstoqueWS", portName="EstoqueWPort") //A nossa classe não possui um nome elegante, vamos corrigir isso já através dos atributos serviceName e portName da anotação @WebService:
