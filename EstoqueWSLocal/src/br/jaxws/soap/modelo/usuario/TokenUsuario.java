...
import br.jaxws.soap.modelo.validador.DateAdapter;

@XmlAccessorType(XmlAccessType.FIELD) //@XmlAccessorType para definir o acesso aos atributo invés de usar os Getter/Setter:
