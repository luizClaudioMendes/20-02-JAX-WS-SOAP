 ...
 * 
 */
@WebServiceClient(name = "EstoqueWS", targetNamespace = "http://ws.estoque.caelum.com.br/", wsdlLocation = "http://localhost:8080/EstoqueWSWeb/EstoqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/EstoqueWSWeb/EstoqueWS?wsdl");
     ...
     *     returns EstoqueWS
     */
    @WebEndpoint(name = "EstoqueWPort")
    public EstoqueWS getEstoqueWPort() {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWPort"), EstoqueWS.class);
    }
     ...
     */
    @WebEndpoint(name = "EstoqueWPort")
    public EstoqueWS getEstoqueWPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWPort"), EstoqueWS.class, features);
    }
